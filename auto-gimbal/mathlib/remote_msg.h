...
/**
  ...
  */
/* Ò£¿Ø×ó²à²¦¸Ë */
#define RC_LEFT_LU  ( 1<<0 ) // ¾Ó×óÉÏ
#define RC_LEFT_RU  ( 1<<1 ) // ¾ÓÓÒÉÏ
#define RC_LEFT_RD  ( 1<<2 ) // ¾ÓÓÒÏÂ
#define RC_LEFT_LD  ( 1<<3 ) // ¾Ó×óÏÂ

/* Ò£¿ØÓÒ²à²¦¸Ë */
#define RC_RIGHT_LU ( 1<<4 )   // ¾Ó×óÉÏ
#define RC_RIGHT_RU ( 1<<5 )   // ¾ÓÓÒÉÏ
#define RC_RIGHT_RD ( 1<<6 )   // ¾ÓÓÒÏÂ
#define RC_RIGHT_LD ( 1<<7 )   // ¾Ó×óÏÂ
